package com.image_uploader.image_uploader.services.impl;

import com.amazonaws.HttpMethod;
import com.amazonaws.services.s3.AmazonS3;
import com.amazonaws.services.s3.model.*;
import com.image_uploader.image_uploader.exceptions.ImageUploadException;
...
private String  bucketName;
    ...
    public String uploadImage(MultipartFile image) {
        ...
        String actualFileName = image.getOriginalFilename(); //abcd.png
        ...
        try {
            ...
            throw new ImageUploadException("Error in uploadImage"+ e.getMessage());
        }
    ...
    public List<String> allFiles() {
        ...
        ListObjectsV2Result listObjectResult=client.listObjectsV2(listObjectRequest);
        List<S3ObjectSummary> objectSummries=listObjectResult.getObjectSummaries();
        List<String> listOfFileUrls=objectSummries.stream().map(item->this.preSignedUrl(item.getKey())).collect(Collectors.toList());
    ...
    public String preSignedUrl(String fileName) {
        ...
        int hour=2; //the presigned will be available only for the 2 hours
